        ...
        <>
          ...
          >
            <div className="flex items-center justify-between border-b border-fitora-border px-5 py-4">
              <h2 className="font-display text-lg font-bold">Mon panier ({lines.length})</h2>
            ...
            {lines.length === 0 ? (
              <div className="flex flex-1 flex-col items-center justify-center gap-3 px-6 text-center">
                ...
                <p className="text-fitora-gray">Votre panier est vide pour le moment.</p>
              ...
              <>
                ...
                <div className="border-t border-fitora-border px-5 py-4">
                  <div className="mb-4 flex items-center justify-between text-sm text-fitora-gray">
                    ...
                    <span className="font-semibold text-fitora-white">{formatFCFA(subtotal)}</span>
                  </div>
